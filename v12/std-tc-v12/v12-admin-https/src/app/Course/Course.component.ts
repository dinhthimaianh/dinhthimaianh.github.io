...
@Component({
  ...
  providers: [CourseService, RestService, PagerService]
})
export class CourseComponent implements OnInit {
  ...
  setPage(page: number) {
        ...
        this.pager = this.pagerService.getPager(this.allAssets.length, page);
        // get current page of items
        this.pagedItems = this.allAssets.slice(this.pager.startIndex, this.pager.endIndex + 1);
  }
